...
\hldef{T} \hlkwb{=} \hlkwd{matrix}\hldef{(}\hlkwc{data} \hldef{=}
             \hlkwd{c}\hldef{(}\hlnum{0}\hldef{,} \hlnum{1268}\hldef{,} \hlnum{900}\hldef{,} \hlnum{489}\hldef{,} \hlnum{200}\hldef{,}
...
\hldef{p}\hlopt{$}\hldef{eta} \hlkwb{=} \hlkwd{rep}\hldef{(}\hlnum{0.3}\hldef{, p}\hlopt{$}\hldef{P)}
\hldef{p}\hlopt{$}\hldef{epsilon} \hlkwb{=} \hlkwd{rep}\hldef{((}\hlnum{1}\hlopt{/}\hlnum{1.5}\hldef{), p}\hlopt{$}\hldef{P)}
\hldef{p}\hlopt{$}\hldef{pi} \hlkwb{=} \hlkwd{rep}\hldef{(}\hlnum{0.7}\hldef{, p}\hlopt{$}\hldef{P)}
\hldef{p}\hlopt{$}\hldef{gammaI} \hlkwb{=} \hlkwd{rep}\hldef{((}\hlnum{1}\hlopt{/}\hlnum{5}\hldef{), p}\hlopt{$}\hldef{P)}
\hldef{p}\hlopt{$}\hldef{gammaA} \hlkwb{=} \hlkwd{rep}\hldef{((}\hlnum{1}\hlopt{/}\hlnum{3}\hldef{), p}\hlopt{$}\hldef{P)}
...
\hldef{p}\hlopt{$}\hldef{idx_A} \hlkwb{=} \hldef{(}\hlnum{3}\hlopt{*}\hldef{p}\hlopt{$}\hldef{P}\hlopt{+}\hlnum{1}\hldef{)}\hlopt{:}\hldef{(}\hlnum{4}\hlopt{*}\hldef{p}\hlopt{$}\hldef{P)}
\hldef{p}\hlopt{$}\hldef{idx_R} \hlkwb{=} \hldef{(}\hlnum{4}\hlopt{*}\hldef{p}\hlopt{$}\hldef{P}\hlopt{+}\hlnum{1}\hldef{)}\hlopt{:}\hldef{(}\hlnum{5}\hlopt{*}\hldef{p}\hlopt{$}\hldef{P)}
\end{alltt}
\end{kframe}
\end{knitrout}
\end{frame}
...
\hldef{A0} \hlkwb{=} \hlkwd{mat.or.vec}\hldef{(p}\hlopt{$}\hldef{P,} \hlnum{1}\hldef{)}
\hldef{R0} \hlkwb{=} \hlkwd{mat.or.vec}\hldef{(p}\hlopt{$}\hldef{P,} \hlnum{1}\hldef{)}
\hldef{I0[}\hlnum{1}\hldef{]} \hlkwb{=} \hlnum{2}
\hldef{S0} \hlkwb{=} \hldef{pop} \hlopt{-} \hldef{(L0} \hlopt{+} \hldef{I0} \hlopt{+} \hldef{A0} \hlopt{+} \hldef{R0)}
\hlcom{# Vector of initial conditions to be passed to ODE solver.}
\hldef{IC} \hlkwb{=} \hlkwd{c}\hldef{(}\hlkwc{S} \hldef{= S0,} \hlkwc{L} \hldef{= L0,} \hlkwc{I} \hldef{= I0,} \hlkwc{A} \hldef{= A0,} \hlkwc{R} \hldef{= R0)}
...
\hlkwa{for} \hldef{(i} \hlkwa{in} \hlnum{1}\hlopt{:}\hldef{p}\hlopt{$}\hldef{P) \{}
  \hldef{p}\hlopt{$}\hldef{beta[i]} \hlkwb{=}
    \hldef{R_0[i]} \hlopt{/} \hldef{S0[i]} \hlopt{*} \hlnum{1} \hlopt{/}
    \hldef{((}\hlnum{1} \hlopt{-} \hldef{p}\hlopt{$}\hldef{pi[i])}\hlopt{/}\hldef{p}\hlopt{$}\hldef{gammaI[i]} \hlopt{+}
       \hldef{p}\hlopt{$}\hldef{pi[i]} \hlopt{*} \hldef{p}\hlopt{$}\hldef{eta[i]}\hlopt{/}\hldef{p}\hlopt{$}\hldef{gammaA[i])}
\hldef{\}}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hldef{SLIAR_metapop_rhs} \hlkwb{<-} \hlkwa{function}\hldef{(}\hlkwc{t}\hldef{,} \hlkwc{x}\hldef{,} \hlkwc{p}\hldef{) \{}
        \hlkwd{with}\hldef{(}\hlkwd{as.list}\hldef{(p), \{}
                ...
                \hldef{A} \hlkwb{=} \hldef{x[idx_A]}
                \hldef{R} \hlkwb{=} \hldef{x[idx_R]}
                \hldef{N} \hlkwb{=} \hldef{S} \hlopt{+} \hldef{L} \hlopt{+} \hldef{I} \hlopt{+} \hldef{A} \hlopt{+} \hldef{R}
                \hldef{Phi} \hlkwb{=} \hldef{beta} \hlopt{*} \hldef{S} \hlopt{*} \hldef{(I} \hlopt{+} \hldef{eta} \hlopt{*} \hldef{A)} \hlopt{/} \hldef{N}
                \hldef{dS} \hlkwb{=} \hlopt{-} \hldef{Phi} \hlopt{+} \hldef{MS} \hlopt{%*%} \hldef{S}
                \hldef{dL} \hlkwb{=} \hldef{Phi} \hlopt{-} \hldef{epsilon} \hlopt{*} \hldef{L} \hlopt{+} \hldef{p}\hlopt{$}\hldef{ML} \hlopt{%*%} \hldef{L}
                \hldef{dI} \hlkwb{=} \hldef{(}\hlnum{1} \hlopt{-} \hldef{pi)} \hlopt{*} \hldef{epsilon} \hlopt{*} \hldef{L} \hlopt{-} \hldef{gammaI} \hlopt{*} \hldef{I} \hlopt{+} \hldef{MI} \hlopt{%*%} \hldef{I}
                \hldef{dA} \hlkwb{=} \hldef{pi} \hlopt{*} \hldef{epsilon} \hlopt{*} \hldef{L} \hlopt{-} \hldef{gammaA} \hlopt{*} \hldef{A} \hlopt{+} \hldef{MA} \hlopt{%*%} \hldef{A}
                \hldef{dR} \hlkwb{=} \hldef{gammaI} \hlopt{*} \hldef{I} \hlopt{+} \hldef{gammaA} \hlopt{*} \hldef{A} \hlopt{+} \hldef{MR} \hlopt{%*%} \hldef{R}
                \hldef{dx} \hlkwb{=} \hlkwd{list}\hldef{(}\hlkwd{c}\hldef{(dS, dL, dI, dA, dR))}
                \hlkwd{return}\hldef{(dx)}
        \hldef{\})}
\hldef{\}}
\end{alltt}
\end{kframe}
...
\hldef{sol} \hlkwb{<-} \hlkwd{ode}\hldef{(}\hlkwc{y} \hldef{= IC,}
                        ...
                        \hlkwc{func} \hldef{= SLIAR_metapop_rhs,}
                        \hlkwc{parms} \hldef{= p,}
                        \hlkwc{method} \hldef{=} \hlsng{"ode45"}\hldef{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(substitute(expr), data, enclos = parent.frame()): object 'MS' not found}}\end{kframe}
\end{knitrout}
\end{frame}
