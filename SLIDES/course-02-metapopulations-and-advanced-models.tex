...
\hldef{SLIAR_metapop_rhs} \hlkwb{<-} \hlkwa{function}\hldef{(}\hlkwc{t}\hldef{,} \hlkwc{x}\hldef{,} \hlkwc{p}\hldef{) \{}
        \hlkwd{with}\hldef{(}\hlkwd{as.list}\hldef{(p), \{}
                ...
                \hldef{dS} \hlkwb{=} \hlopt{-} \hldef{Phi} \hlopt{+} \hldef{M} \hlopt{%*%} \hldef{S}
                \hldef{dL} \hlkwb{=} \hldef{Phi} \hlopt{-} \hldef{epsilon} \hlopt{*} \hldef{L} \hlopt{+} \hldef{p}\hlopt{$}\hldef{M} \hlopt{%*%} \hldef{L}
                \hldef{dI} \hlkwb{=} \hldef{(}\hlnum{1} \hlopt{-} \hldef{pi)} \hlopt{*} \hldef{epsilon} \hlopt{*} \hldef{L} \hlopt{-} \hldef{gammaI} \hlopt{*} \hldef{I} \hlopt{+} \hldef{M} \hlopt{%*%} \hldef{I}
                \hldef{dA} \hlkwb{=} \hldef{pi} \hlopt{*} \hldef{epsilon} \hlopt{*} \hldef{L} \hlopt{-} \hldef{gammaA} \hlopt{*} \hldef{A} \hlopt{+} \hldef{M} \hlopt{%*%} \hldef{A}
                \hldef{dR} \hlkwb{=} \hldef{gammaI} \hlopt{*} \hldef{I} \hlopt{+} \hldef{gammaA} \hlopt{*} \hldef{A} \hlopt{+} \hldef{M} \hlopt{%*%} \hldef{R}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(substitute(expr), data, enclos = parent.frame()): object 'idx\_A' not found}}\end{kframe}
\end{knitrout}
\end{frame}
