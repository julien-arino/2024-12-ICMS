...
\vfill
\bbullet See in particular the works of \href{https://www.semanticscholar.org/author/J.-Jacquez/2321059}{John Jacquez}, \href{https://scholar.google.ca/citations?user=dv_z_mAAAAAJ}{Carl Simon}, GG Walter
\vfill
...
\vfill
\begin{center}
\includegraphics[width=0.8\textwidth]{\Sexpr{fig_chunk('KMK_SI_plane', 'pdf')}}
\end{center}
\end{frame}
